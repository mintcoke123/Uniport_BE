    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(a -> a
                        ...
                        .requestMatchers("/api/auth/**", "/api/me/**", "/api/market/**", "/api/stocks/**", "/api/news/**", "/api/ohlcv", "/api/trades", "/api/competitions/**", "/api/ranking/**", "/api/groups/**", "/api/admin/**", "/api/admin-console/**", "/api/festival-admin/**", "/api/config/**", "/api/health", "/api/home/group-insights", "/api/shop/items", "/api/festival/**", "/h2-console/**", "/error", "/swagger-ui/**", "/swagger-ui.html", "/v3/api-docs/**").permitAll()
