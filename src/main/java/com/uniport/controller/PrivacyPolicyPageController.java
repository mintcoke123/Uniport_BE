    ...
    private static final String PRIVACY_POLICY_HTML = """
            ...
            <body>
              <main>
                ...
                <p class="effective-date">시행일: 2026년 5월 14일</p>
                <p>Uniport는 모의투자, 투자 학습, 그룹 투자 토론, 친구 초대, 알림 기능을 제공하는 모바일 앱입니다. Uniport는 서비스 제공에 필요한 범위에서 개인정보와 앱 이용 데이터를 처리하며, 광고 목적의 판매나 타사 광고 추적에는 사용하지 않습니다.</p>
                ...
                <h2>8. 광고 및 추적</h2>
                <p>Uniport는 현재 맞춤형 광고를 표시하지 않으며, 광고 목적의 사용자 추적을 하지 않습니다. 또한 사용자 데이터를 데이터 브로커에게 판매하지 않습니다.</p>
