...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "투자 이슈 상세 응답")
public class InvestmentIssueDetailResponseDTO {
    ...
    private List<InvestmentIssueSourceArticleDTO> sourceArticles;
}
