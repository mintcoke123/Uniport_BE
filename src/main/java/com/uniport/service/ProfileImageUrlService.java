...
public class ProfileImageUrlService {
    ...
    private static final Map<String, String> ONBOARDING_CHARACTER_CODES = Map.ofEntries(
            ...
            Map.entry(normalizeCharacterName("전략짜는 올빼미형"), "OWL"),
