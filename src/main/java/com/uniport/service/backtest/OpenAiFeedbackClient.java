...
public class OpenAiFeedbackClient implements LlmFeedbackClient {
    ...
    private String systemPrompt() {
        return "You write short Korean ETF backtest feedback. "
                ...
                + "The summary must start with 한 줄 결론:, stay under 70 Korean characters when possible, and evaluate the whole portfolio, not list the holding combination. "
                ...
                + "Bullet 1 message must start with 핵심 원인:, stay compact, and give the main interpretation behind the portfolio score using named holdings only as evidence. "
                + "Bullet 2 message must start with 최대 리스크 요인: and explain the weak spot in practical language, not raw metrics. "
