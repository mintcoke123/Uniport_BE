...
class RankingServiceTest {
    ...
    void activeTeamLeaderboardSortsByReturnRateThenCurrentAssets() {
        ...
        when(matchingRoomRepository.findByStatusAndCompetitionIdIsNullOrderByCreatedAtDesc("started"))
                .thenReturn(List.of(steadyRoom, leadingRoom));
    ...
    void activeTeamLeaderboardExcludesTournamentRooms() {
        ...
        when(matchingRoomRepository.findByStatusAndCompetitionIdIsNullOrderByCreatedAtDesc("started"))
                .thenReturn(List.of(alwaysOnRoom));
    ...
    void activeTeamLeaderboardUsesCurrentAssetsAsTieBreakerWhenReturnRatesAreEqual() {
        ...
        when(matchingRoomRepository.findByStatusAndCompetitionIdIsNullOrderByCreatedAtDesc("started"))
                .thenReturn(List.of(lowerAssetRoom, higherAssetRoom));
    ...
    void activeTeamLeaderboardUsesGroupIdAsFinalTieBreakerWhenReturnRateAndAssetsAreEqual() {
        ...
        when(matchingRoomRepository.findByStatusAndCompetitionIdIsNullOrderByCreatedAtDesc("started"))
                .thenReturn(List.of(higherIdRoom, lowerIdRoom));
